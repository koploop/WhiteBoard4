...
## 2026-03-11
- `/plan \`/Users/pep/Desktop/github/WhiteBoard4/WhiteBoard4/docs/RequestDoc.md\` 实现 RDV0.2.0版本的需求`
- `步骤 3 中原生 View 的承载层需要通用化,例如后续可以支持其他原生 View 如 WebView, 自定义 View 等, 不应该单单是这次的便签的承载体`
- `问题1 : 原生 View 类别的元素, 需要支持在任何状态下(书写/擦除/选中)点击就进入选中态`
- `问题 2: 便签进入编辑态弹出键盘后点击空白处, 键盘收起,但光标依然在,无法退出编辑态`
- `问题: 选中便签后进行移动, 文字内容未跟随移动`
- `愿意`
- `优化后出现的问题: 点击编辑进入编辑态键盘弹出后, 键盘输入文字便签不显示, 且无法收起键盘, 无法退出编辑态了.`
