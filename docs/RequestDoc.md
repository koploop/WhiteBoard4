...
## RDV0.1.1
- 在需求RDV0.0.9增加 HandEraser 的基础上, 扩展一种新的触摸点类型 Finger, 手笔分离模式开启情况下且书写模式下, 当触摸点类型是 Finger 时, 执行元素的移动操作,具体逻辑如下:
    - 当触摸点类型是 Finger 时, 对触摸点命中的元素执行移动操作, 移动元素过程中移动的距离为触摸点的移动距离。
